...
public class Kpi10_2WorksheetHandler : WorksheetExportHandlerBase
{
    ...
    public Kpi10_2WorksheetHandler(ExcelPackage excelPackage, string listName, SprintReportEntity sprintReportEntity)
    {
        ListName = listName;
